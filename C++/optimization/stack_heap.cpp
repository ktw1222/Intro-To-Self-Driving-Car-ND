...
// This creates five integer variables on the stack and five integer variables on the heap.
// The program then prints out their adddresses in memory.
// You'll see the results in hexadecimal as well as in binary format. 
// Notice that the stack first assigns a higher number address and then works backwards.
